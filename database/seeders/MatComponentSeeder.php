...
class MatComponentSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('mat_components')->insert([
            ['code' => 'BRW', 'fileName' => 'assets/img/customMat/fondo1.png', 'description' => 'Standar Brown', 'type' => 'B', 'created_at' => '2021-03-12 13:33:59', 'updated_at' => '2021-03-14 20:09:33'],
            ['code' => 'YLW', 'fileName' => 'assets/img/customMat/fondo2.png', 'description' => 'Yellow', 'type' => 'B', 'created_at' => '2021-03-12 13:33:59', 'updated_at' => '2021-03-14 20:09:33'],
