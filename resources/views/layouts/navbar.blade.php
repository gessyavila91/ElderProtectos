...
<div class="sticky-top">
    ...
    <nav class="navbar navbar-expand-sm navbar-light float-right bg-white rounded-bottom shadow">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapse-1">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown"><a title="Shops" class="nav-link"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item"><a href="https://www.etsy.com/shop/ElderProtectors" title="Etsy"
                                                    target="_blank" class="nav-link">Etsy</a>
                            </li>
                            <li class="nav-item"><a href="https://www.ebay.com/sch/kevkabr/m.html" title="Ebay"
                                                    target="_blank" class="nav-link">Ebay</a></li>
                            <li class="nav-item"><a
                                        href="https://articulo.mercadolibre.com.mx/MLM-820037873-playmat-de-cuero-_JM"
                                        title="Mercado Libre" target="_blank" class="nav-link">Mercado
                                    Libre</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item"><a href="/myprofile" title="Account" class="nav-link"><i
                                    class="fas fa-user"></i>Gessy</a></li>
                </ul>
            </div>
        </div>
