        ...
        <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
            ...
            <style>
                ...
                .bg-primary:hover {
                    ...
                    box-shadow:
                            0 0 60px 3px #fff,  /* inner white */
                            0 0 100px 6px #6a00ff, /* middle magenta */
            ...
            <div class="px-lg-5">
                ...
                <div class="py-5">
                    <div class="animate__animated animate__fadeInDown">
                        <div class="p-5 shadow-sm rounded bg-degraded-2 text-dark  text-center">
                            ...
                            <p class="lead">Lorem ipsum dolor sit amet consectetur adipiscing, elit rhoncus euismod lectus ad
                                elementum, purus metus tortor arcu auctor ultrices,
                                dictum et at mauris convallis. Tellus auctor ultricies sagittis non tortor lectus fames odio,
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="bg-degraded-1 rounded shadow-sm animate__animated animate__fadeInLeft animate__delay-2s"><img
                                    ...
                                    alt="" class="img-fluid card-img-top" style="height: 250px; object-fit: cover; object-position: center center;">
                            <div class="p-4">
                                <h5><a href="#" class="text-white" data-toggle="modal" data-target="#modal1">Red paint cup</a>
                                </h5>
                                <p class="small text-white mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                                <div class="d-flex align-items-center justify-content-between rounded-pill bg-degraded-2 text-white px-3 py-2 mt-4">
                                    ...
                                    <div class="badge bg-primary px-3 rounded-pill font-weight-normal">Trend</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="bg-degraded-1 rounded shadow-sm animate__animated animate__fadeInLeft animate__delay-1s"><img
                                    src="https://i.etsystatic.com/iap/a0075d/2402105005/iap_640x640.2402105005_2ynyeq2l.jpg?version=0"
                                    alt="" class="img-fluid card-img-top" style="height: 250px; object-fit: cover; object-position: center center;">
                            <div class="p-4">
                                <h5><a href="" class="text-white " onclick="changeActiveState(1)" data-toggle="modal"
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="bg-degraded-1 rounded shadow-sm animate__animated animate__fadeInRight animate__delay-1s"><img
                    ...
                    <!-- Gallery item -->
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                        <div class="bg-degraded-1 rounded shadow-sm animate__animated animate__fadeInRight animate__delay-2s"><img
