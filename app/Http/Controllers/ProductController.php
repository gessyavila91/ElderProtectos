...
class ProductController extends Controller {
    ...
    private function validShippingRequest(Request $request) {
        ...
        if(
            isset($request->shipping_line1) &&
            isset($request->shipping_line2) &&
            isset($request->shipping_city) &&
            isset($request->shipping_state) &&
            isset($request->shipping_postal_code) &&
            isset($request->shipping_country_code)
        ) {
            $valid = true;
        }
        return $valid;
